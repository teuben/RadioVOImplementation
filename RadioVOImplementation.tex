...
\title{Radio astronomy in the VO: services implementation review} 
...
\author[https://wiki.ivoa.net/twiki/bin/view/IVOA/Jean-MathiasGriessmeier]{Jean-Mathias Griessmeier}
...
\author[https://wiki.ivoa.net/twiki/bin/view/IVOA/MireilleLouys]{Mireille Louys}
...
\author[https://wiki.ivoa.net/twiki/bin/view/IVOA/PeterTeuben]{Peter Teuben}
...
difficult. 
\begin{itemize}
\item ObsTAP services: ATOA, MWA (section~\ref{sec:MWA}), ASKAP, JIVE (section~\ref{sec:JIVE})
...
The LMT (Large Millimeter Telescope) has several instruments, both continuum mapping and pointed as well
as spectral line mapping in the 70 - 260 GHz range.  An archive using DataVerse is under construction
(April 2023) and more information on this will be written down here soon.
